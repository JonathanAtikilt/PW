...
const ITEMS = [
  {
    id: "email",
    label: "EMAIL",
    handle: "atikiltjonathan@gmail.com",
    href: "mailto:atikiltjonathan@gmail.com",
    icon: "🎮",
    barIcon: icon1,
    newBars: [0],
    links: [
      { label: "ATIKILTJONATHAN@GMAIL.COM", url: "mailto:atikiltjonathan@gmail.com", metric: "MAIL", value: "OPEN" },
    ],
    stats: [
      { tag: "MAIL", value: "GML", color: "#9147ff" },
      { tag: "MSG", value: "SEND", color: "#bf94ff" },
    ],
  },
  {
    id: "linkedin",
    label: "LINKEDIN",
    handle: "linkedin.com/in/jatikilt",
    href: "https://www.linkedin.com/in/jatikilt/",
    icon: "📷",
    barIcon: icon2,
    newBars: [0],
    links: [
      { label: "LINKEDIN.COM/IN/JATIKILT", url: "https://www.linkedin.com/in/jatikilt/", metric: "VIEW", value: "IN" },
      { label: "UC SANTA CRUZ COMPUTER SCIENCE", url: "https://www.ucsc.edu/", metric: "UCSC", value: "2027" },
    ],
    stats: [
      { tag: "NET", value: "IN", color: "#e1306c" },
      { tag: "CS", value: "MS",  color: "#f77737" },
    ],
  },
  {
    id: "github",
    label: "GITHUB",
    handle: "github.com/JonathanAtikilt",
    href: "https://github.com/JonathanAtikilt?tab=repositories",
    icon: "🎵",
    barIcon: icon3,
    newBars: [0],
    links: [
      { label: "GITHUB.COM/JONATHANATIKILT", url: "https://github.com/JonathanAtikilt?tab=repositories", metric: "CODE", value: "VIEW" },
      { label: "LINKUP / PLOTGUARD / NEMOPILOT", url: "https://github.com/JonathanAtikilt?tab=repositories", metric: "REPO", value: "ALL" },
    ],
    stats: [
      { tag: "GIT", value: "HUB", color: "#00f2ea" },
      { tag: "SRC", value: "CODE", color: "#ff0050" },
    ],
  },
];
    ...
    <div id="menu-screen">
      <style>{`
        ...
        @media (max-width: 768px) {
          .sc-bar, .sc-bar-red { width: min(45vw, calc(100% - 8px)); }
          .sc-info-bar-wrap { left: 50%; max-width: 50%; }
          .sc-info-bar-text { font-size: clamp(12px, 2.8vw, 19px); letter-spacing: 0.5px; }
          .sc-info-bar-box, .sc-info-bar-count { font-size: clamp(14px, 3.2vw, 20px); }
          .sc-info-bar-count { margin-right: 8px; }
        }

        @media (max-width: 520px) {
          .sc-role { font-size: clamp(28px, 8vw, 50px); }
          .sc-label { font-size: clamp(18px, 5vw, 28px); letter-spacing: 2px; }
          .sc-main { padding-left: clamp(20px, 12vw, 78px); }
        }
      `}</style>
      ...
      {mounted && ITEMS[active].links.map((link, i) => (
        <div
          className={`sc-info-bar-wrap${activeInfoBar === i ? " selected" : ""}`}
          key={`bar-${active}-${i}`}
          style={{ top: `calc(17vh + ${i} * 6.25vh)`, animationDelay: `${i * 50}ms` }}
        ...
        >
          ...
          <div className="sc-info-bar">
            ...
            <span className="sc-info-bar-text">{link.label}</span>
            <span className="sc-info-bar-box">{link.metric}</span>
            <span className="sc-info-bar-count">{link.value}</span>
          </div>
        </div>
      ))}
