...
export const FEATURE_SELECTOR =
  ".p3-row, .sc-bar-outer, .sc-info-bar-wrap, .resume-card-wrap, .p3-page-back-bar, .p3-screen-backdrop, .resume-detail-row-link, .experience-lab-link, a.resume-detail-row-link";
